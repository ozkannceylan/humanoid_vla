...
echo ""
echo "========================================================================"
echo "PART 2/6: Installing ROS2 Jazzy..."
echo "========================================================================"
...
if [ -f "/opt/ros/jazzy/setup.bash" ]; then
    ...
    echo "Installing ROS2 Jazzy Desktop (this may take 10-15 minutes)..."
...
pip3 install --break-system-packages mujoco opencv-python numpy pynput
